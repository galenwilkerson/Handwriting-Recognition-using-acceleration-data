...
# load data
preprocessed_data_filename = "../data/preprocessed_data_linear.pkl"
...
training_data_file = open("../data/training_data_linear.pkl", 'wb')
cPickle.dump(training_data, training_data_file)
test_data_file = open("../data/test_data_linear.pkl", 'wb')
...
predict_filename = "../data/predictions_linear.pkl"
