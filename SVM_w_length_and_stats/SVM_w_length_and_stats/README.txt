...
- using 10 resamplings WITH outer product (X_2) and STROKE LENGTH (NOT CENTERED OR NORMALIZED): 88%
- using 10 resamplings WITH outer product (X_2) and weighted (100 *)STROKE LENGTH (NOT CENTERED OR NORMALIZED): 87.4%
